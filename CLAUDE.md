# CLAUDE.md — Auto-generated by .ai/generate.sh on 2026-04-10
...
GENERATED: 2026-04-10 from project.yml + code scan
...
PINNED VERSIONS (extracted from code — do not override):
  ...
  ${OLLAMA_AI_IMAGE: -botanical-ai-ollama}:${IMAGE_TAG:-v1.0.0}
  ${PORTAL_NGINX_IMAGE: -botanical-portal-nginx}:${IMAGE_TAG:-v1.0.0}
  ${RSTUDIO_SAMBA_IMAGE: -rstudio-botanical-samba}:${IMAGE_TAG:-v1.0.0}
  ${RSTUDIO_SSSD_IMAGE: -rstudio-botanical-sssd}:${IMAGE_TAG:-v1.0.0}
  ${TELEMETRY_API_IMAGE: -botanical-telemetry-api}:${IMAGE_TAG:-v1.0.0}
  caddy: 2.9.1-alpine
